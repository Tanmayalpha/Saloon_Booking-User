...
class Address extends Model {
  ...
  Address.fromJson(Map<String, dynamic> json) {
    ...
    latitude = doubleFromJson(json, 'latitude', defaultValue: 18.52189077471387);
    longitude = doubleFromJson(json, 'longitude', defaultValue: 73.85588410330736);
  ...
  LatLng getLatLng() {
    ...
    if (this.isUnknown()) {
      return LatLng(18.52189077471387, 73.85588410330736);
    } else {
