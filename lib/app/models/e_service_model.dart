...
class EService extends Model {
  ...
  EService.fromJson(Map<String, dynamic> json) {
    ...
    duration1 = stringFromJson(json, 'duration');
    featured = boolFromJson(json, 'featured');
    enableBooking = json['enable_booking'] is int
        ? json['enable_booking'] == 1
            ? true
            : false
        : json['enable_booking'];
    enableAtCustomerAddress = json['enable_at_customer_address'] is int
        ? json['enable_at_customer_address'] == 1
            ? true
            : false
        : json['enable_at_customer_address'];
    enableAtSalon = json['enable_at_salon'] is int
        ? json['enable_at_salon'] == 1
            ? true
            : false
        : json['enable_at_salon'];
    showDesc = false;
