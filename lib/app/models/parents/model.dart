  ...
  String durationFromJson(Map<String, dynamic> json, String attribute,
    ...
    try {
      if (json[attribute] != null &&
          int.parse(json[attribute].toString().split(":")[0]) == 0) {
        return DateFormat("mm'm'").format(DateFormat(fromFormat).parse(
            stringFromJson(json, attribute, defaultValue: defaultValue)));
      }
      if (json[attribute] != null &&
          int.parse(json[attribute].toString().split(":")[1]) == 0) {
        return DateFormat("hh'h'").format(DateFormat(fromFormat).parse(
            stringFromJson(json, attribute, defaultValue: defaultValue)));
      }
