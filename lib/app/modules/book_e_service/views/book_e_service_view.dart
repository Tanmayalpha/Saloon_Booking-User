                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      itemCount: controller.booking.value.eServices.length,
                      separatorBuilder: (context, index) {
                        return SizedBox(height: 6);
                      },
                      itemBuilder: (context, index) {
                        var _employee =
                            controller.booking.value.eServices.elementAt(index);
                        return Container(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      width: 42,
                                      fit: BoxFit.cover,
                                      imageUrl: _employee.firstImageUrl,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        var _employee = controller.booking.value.salon.employees
                            .elementAt(index);
                        return index != 0&&!_employee.isOff
                            ? GestureDetector(
                                onTap: () {
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                Row(
                  children: [
                    if(controller.booking.value.getDiscountSubtotal()>0)
                      Ui.getPrice(
                        controller.booking.value.getDiscountSubtotal(),
                        style: Get.textTheme.headline6.merge(
                            TextStyle(
                                color: Get.theme.focusColor,
                                decoration:
