          ...
          children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Salon Details", style: Get.textTheme.bodyText1),
                    SizedBox(height: 8),
                    Row(
                      children: [
                        Icon(Icons.accessibility_new_sharp, color: Get.theme.focusColor),
                        SizedBox(width: 15),
                        Expanded(
                          child: Obx(() {
                            return Column(
                              ...
                              children: [
                                Text(controller.booking.value.salon.name, style: Get.textTheme.bodyText2),
                              ],
                            );
                          }),
                        ),
