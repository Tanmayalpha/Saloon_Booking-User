                                ...
                                if (controller.booking.value.bookingAt != null)
                                  BookingRowWidget(
                                      ...
                                      child: Align(
                                          ...
                                          child: Text(
                                            DateFormat('d, MMMM y  h:mma', Get.locale.toString()).format(controller.booking.value.bookingAt),
                                ...
                                if (controller.booking.value.startAt != null)
                                  BookingRowWidget(
                                      ...
                                      child: Align(
                                          alignment: Alignment.centerRight,
                                          child: Text(
                                            DateFormat('d, MMMM y  h:mma', Get.locale.toString()).format(controller.booking.value.startAt),
                                            style: Get.textTheme.caption,
                                            textAlign: TextAlign.end,
                                          )),
                                      hasDivider: false),
                                if (controller.booking.value.endsAt != null)
                                  BookingRowWidget(
                                    ...
                                    child: Align(
                                        alignment: Alignment.centerRight,
                                        child: Text(
                                          DateFormat('d, MMMM y  h:mma', Get.locale.toString()).format(controller.booking.value.endsAt),
                                          style: Get.textTheme.caption,
                                          textAlign: TextAlign.end,
                                        )),
                                  ),
            ...
            if (_booking.value.bookingAt != null)
              Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text(DateFormat('h:mma', Get.locale.toString()).format(_booking.value.bookingAt),
                        maxLines: 1,
