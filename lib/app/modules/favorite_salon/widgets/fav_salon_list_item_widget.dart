...
import 'package:beauty_salons_customer/app/modules/favorite_salon/controllers/favorites_controller.dart';
...
class FavoritesSalonItemWidget extends GetView<FavoritesSalonController> {
  FavoritesSalonItemWidget({
    Key key,
    ...
    return GestureDetector(
      onTap: () {
        Get.toNamed(Routes.SALON,
            arguments: {'salon': _service, 'heroTag': 'service_list_item','offer':"0"});
      },
      child: Container(
...
class FavoritesSalonItemWidget1 extends GetView<FavoritesSalonController> {
  FavoritesSalonItemWidget1({
    Key key,
    @required this.value,
    @required Salon service,
  })  : _service = service,
          ...
          children: [
            Column(
              children: [
                ...
                SalonAvailabilityBadgeWidget(salon: _service, withImage: true)
              ],
            ),
            SizedBox(width: 12),
            Expanded(
              child: Wrap(
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: [
                      DurationChipWidget(
                          duration: _service.distance.toString()),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          if (_service.totalReviews > 0)
                            Text(
                              _service.totalReviews.toString() + " Reviews",
                              maxLines: 1,
                              overflow: TextOverflow.fade,
                              softWrap: false,
                              style: Get.textTheme.bodyText1,
                  ...
                  value == ""
                      ...
                      : _service.eService != null &&
                              _service.eService.length > 0
                          ? Wrap(
                              spacing: 5,
                              children: List.generate(_service.eService.length,
                                  (index) {
                                return Container(
                                  padding: EdgeInsets.symmetric(
                                      horizontal: 10, vertical: 4),
                                  child: Text(
                                      _service.eService.elementAt(index).name,
                                      style: Get.textTheme.caption
                                          .merge(TextStyle(fontSize: 10))),
                                  decoration: BoxDecoration(
                                      color: Get.theme.primaryColor,
