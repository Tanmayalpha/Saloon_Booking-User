...
//   }
// }
import 'package:beauty_salons_customer/app/models/new_model/buzz_model.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart' show DateFormat;
...
class BuzzItem extends GetView<BuzzController> {
  ...
  Widget build(BuildContext context) {
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index){
            return Card(
              ...
              child: Column(
                children: [
                Text(buzz.title.toString(),
                  style: Get.textTheme.headline6.merge(TextStyle(letterSpacing: 1.3),
                  ),
                ),
                SizedBox(height: 10),
                // Text(buzz.description.toString()),
                Ink.image(
                  image: AssetImage(buzz.image),
                ),
              ],
              ),
            );
    ...
    // if (Get.find<AuthService>().user.value.id == this.buzz.userId) {
    //   if (buzz.text.isURL) {
    //     return getSentMessageImageLayout(context);
    //   } else {
    //     return getSentMessageTextLayout(context);
  ...
  //                   crossAxisAlignment: CrossAxisAlignment.end,
  //                   children: <Widget>[
  //                     new Text(this.buzz.user.name, style: Get.textTheme.bodyText2.merge(TextStyle(fontWeight: FontWeight.w600))),
  //                     new Container(
  //                       margin: const EdgeInsets.only(top: 5.0),
  //                       child: new Text(buzz.text, style: Get.textTheme.bodyText1),
  //                     ),
  //                   ],
  //                 ),
  //               ),
  ...
  //                     width: double.infinity,
  //                     fit: BoxFit.cover,
  //                     imageUrl: this.buzz.user.avatar.thumb,
  //                     placeholder: (context, url) => Image.asset(
  //                       'assets/img/loading.gif',
  //                       fit: BoxFit.cover,
  //                       width: double.infinity,
  ...
  //           padding: const EdgeInsets.symmetric(horizontal: 10),
  //           child: Text(
  //             DateFormat('d, MMMM y | HH:mm', Get.locale.toString()).format(DateTime.fromMillisecondsSinceEpoch(this.buzz.time)),
  //             overflow: TextOverflow.fade,
  //             softWrap: false,
  //             style: Get.textTheme.caption,
  //           ),
  ...
  //                   crossAxisAlignment: CrossAxisAlignment.end,
  //                   children: <Widget>[
  //                     new Text(this.buzz.user.name, style: Get.textTheme.bodyText1.merge(TextStyle(fontWeight: FontWeight.w600))),
  //                     new Container(
  //                       margin: const EdgeInsets.only(top: 5.0),
  //                       child: InkWell(
  //                         onTap: () {
  //                           Get.toNamed(Routes.GALLERY, arguments: {
  //                             'media': [new Media(id: this.buzz.text, url: this.buzz.text)],
  //                             'current': new Media(id: this.buzz.text, url: this.buzz.text),
  //                             'heroTag': 'chat_image'
  //                           });
  //                         },
  //                         child: ClipRRect(
  ...
  //                   crossAxisAlignment: CrossAxisAlignment.start,
  //                   children: <Widget>[
  //                     new Text(this.buzz.user.name, style: Get.textTheme.bodyText2.merge(TextStyle(fontWeight: FontWeight.w600, color: Get.theme.primaryColor))),
  //                     new Container(
  //                       margin: const EdgeInsets.only(top: 5.0),
  //                       child: new Text(
  //                         buzz.text,
  ...
  //           padding: const EdgeInsets.symmetric(horizontal: 10),
  //           child: Text(
  //             DateFormat('HH:mm | d, MMMM y', Get.locale.toString()).format(DateTime.fromMillisecondsSinceEpoch(this.buzz.time)),
  //             overflow: TextOverflow.fade,
  //             softWrap: false,
  //             style: Get.textTheme.caption,
  //           ),
