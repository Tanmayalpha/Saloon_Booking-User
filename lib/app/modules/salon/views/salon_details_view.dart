    ...
    return Obx(() {
      return Wrap(
        children: [
          ...
          SalonTilWidget(
            title: Text("Amenities".tr, style: Get.textTheme.subtitle2),
            content: Obx(() {
              if (controller.salon.value.amenities == null) {
                return SizedBox();
              }
              return Wrap(
                spacing: 5,
                children: List.generate(controller.salon.value.amenities.length, (index) {
                  return Container(
                    padding: EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                    child: Text(controller.salon.value.amenities.elementAt(index).text, style: Get.textTheme.caption.merge(TextStyle(fontSize: 10))),
      ...
      content: (controller.salon.value.availabilityHours?.isEmpty ?? false)
          ...
          : ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                controller.salon.value.groupedAvailabilityHours().entries.elementAt(index);
