        ...
        body: RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
    Obx(() { return controller.wallets.isNotEmpty?Container(
                    height: 190,
                    child: Obx(() {
                  ...
                  Obx(() {
                    ...
                    if(controller.walletTransactions.isEmpty){
                      return Container(
                          ...
                          child: Center(child: Text("No Transactions".tr, style: Get.textTheme.headline5).paddingOnly(top: 25, bottom: 10, right: 22, left: 22)));
                    }
                    return ListView.builder(
