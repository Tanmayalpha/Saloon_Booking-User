...
class PaymentRepository {
  ...
  Future<Map> addBlock(String id,String date,String time) {
    return _laravelApiClient.addBlock(id,date,time);
  }
  ...
  String getRazorPayWalletUrl(String amount) {
    return _laravelApiClient.getRazorWalletPayUrl(amount);
  }
