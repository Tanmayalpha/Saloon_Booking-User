...
/// New Buzz fuction
  Future<List<BuzData>> getBuzzRecommended() {
    print("Working@@@@@");
    return _laravelApiClient.getRecommendedBuzz();
  }
  ...
  Future<List<Category>> getCatSalonEServices(String salonId, List<String> categories, String isOffer,{int page}) {
    return _laravelApiClient.getCatSalonEServices(salonId, categories, page,isOffer);
  }
  ...
  Future<List> getAvailabilityHours(String eProviderId, DateTime date, String employeeId,String minute,String isOffer) {
    return _laravelApiClient.getAvailabilityHours(eProviderId, date, employeeId,minute,isOffer);
  }
  Future<bool> deleteQuery(String id) {
    return _laravelApiClient.deleteQuery(id);
  }
}
