...
import 'package:beauty_salons_customer/app/modules/details/bindings/contact_binding.dart';
import 'package:beauty_salons_customer/app/modules/details/views/contact_us_view.dart';
import 'package:beauty_salons_customer/app/modules/details/views/detail_view.dart';
import 'package:beauty_salons_customer/app/modules/details/views/my_query.dart';
import 'package:beauty_salons_customer/app/modules/favorite_salon/bindings/favorites_binding.dart';
import 'package:beauty_salons_customer/app/modules/favorite_salon/views/favorites_view.dart';
...
import '../modules/favorites/bindings/favorite_salon_binding.dart';
import '../modules/favorites/views/favorite_salon_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.CHAT, page: () => BuzzView(), binding: RootBinding(), middlewares: [AuthMiddleware()]),
    ...
    GetPage(name: Routes.REGISTER, page: () => LoginView(), binding: AuthBinding()),
    ...
    GetPage(name: Routes.FAVORITES_SALON, page: () => FavoritesSalonView(), binding: FavoritesSalonBinding(), middlewares: [AuthMiddleware()]),
